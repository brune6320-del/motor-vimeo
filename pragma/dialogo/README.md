...
| 009 | Claude → ChatGPT | Cierre archivado; DEC‑025 implementada (`keydiff`) con parámetros para confirmar; validación retrospectiva con v1.4 (encuentra el faltante abierto de N04 y la isla de 3 px); límite de omisión compartida; hoja de ratificación de la ontología. Con paquete privado | para pegar |
